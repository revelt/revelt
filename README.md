👋 Hi! I'm Roy. I like to write and maintain Open Source JS/TS programs. Also I like to lift, to draw and to drink beer but who does not?
...
- [`detergent`](https://codsen.com/os/html-crush) — all-in-one tool to prepare text for copy-pasting into HTML — invisible character cleaner, encoder and English style fixer (see the [GUI](https://detergent.io))
